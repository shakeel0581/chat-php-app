...
class Users
{
    ...
    {
        $acc = ServiceAccount::fromJsonFile(__DIR__ . '/auth-7b857-578bd938bb8f.json');
    ...
    public function insert(array $data)
    {
        ...
        foreach ($data as $key => $value) {
            $this->database->getReference()->getChild($this->dbname)->getValue($key)->set($value);
        }
        return TRUE;
    }
...
<div class="quiz-window">
  <div class="quiz-window-header">
    <div class="quiz-window-title">Chat List</div>
  ...
  <div class="quiz-window-body">
    <div class="gui-window-awards">
      ...
      <ul class="guiz-awards-row guiz-awards-row-even">
        ...
        <li class="guiz-awards-title"><?php echo $item['Name']; ?>
          <div class="guiz-awards-subtitle"><?php echo $item['Name']; ?></div>
        </li>
      </ul>
  <?php } ?>
    </div>
